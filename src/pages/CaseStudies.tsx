      ...
      <main className="flex-grow pt-20">
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            ...
            {/* Featured Case Study */}
            <div className="bg-white rounded-xl overflow-hidden shadow-md border border-gray-100 mb-16">
              <div className="grid md:grid-cols-2">
                ...
                <div className="p-8 md:p-12 flex flex-col justify-center">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mb-4">How We Helped ABC Manufacturing Triple Their Production Capacity</h2>
...
const CaseStudyCard: React.FC<CaseStudyCardProps> = ({ image, title, category, metrics, description }) => {
  return (
